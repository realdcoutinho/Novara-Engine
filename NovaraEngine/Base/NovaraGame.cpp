...
HRESULT NovaraGame::Run(HINSTANCE hInstance)
{
...
HRESULT NovaraGame::InitializeWindow()
{
...
HRESULT NovaraGame::InitializeDirectX()
{
...
HRESULT NovaraGame::InitializeGame()
{
	//******************
	//MANAGER INITIALIZE
...
#pragma region
void NovaraGame::StateChanged(int state, bool active)
{
	if (state == 1)
	{
...
LRESULT NovaraGame::WindowProcedureHook(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
...
#pragma region
void NovaraGame::GameLoop() const
{
...
// Update PP
RenderTarget* NovaraGame::GetRenderTarget() const
{
